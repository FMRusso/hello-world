...
local anos "2007 2008 2009 2011 2012"
foreach y in `anos' {
...
** Posi??o no domic?lio
recode v0401 (1=1 "chefe de fam?lia") (2=2 "c?njuge") (3=3 "filho") (4/8=4 "outro"), gen(pdom)
gen respons= (pdom==3)
gen conjuge= (pdom==5)
gen filho= (pdom==7)
gen outro= (pdom>8)
...
label var pos_ocup "posi??o na ocupa??o"
label var renda2 "renda todas as fontes2"
label var salmp "sal?rio trab principal"
label var salmt "sal?rio todos trabs"
label var d_acimat "salmt acima teto RGPS"
label var teto "teto RGPS"
label var Nfilhos "n?mero de filhos"
label var prev "contribui prev"
label var prev_pri "contribui prev privada"
label var ocup_ibge "dummy ocupa??o"
label var chefed "chefe do domic?lio"
...
** Compatibilizando vari?veis de 1995 a 2012
